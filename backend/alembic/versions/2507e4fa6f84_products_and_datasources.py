...
def upgrade() -> None:
    ...
    if not enum_exists('productstatus'):
        op.execute("CREATE TYPE productstatus AS ENUM ('DRAFT', 'RUNNING', 'READY', 'FAILED')")
    
    # Create datasourcetype enum if it doesn't exist
    if not enum_exists('datasourcetype'):
        op.execute("CREATE TYPE datasourcetype AS ENUM ('WEB', 'DB', 'CONFLUENCE', 'SHAREPOINT', 'FOLDER')")
    ...
    if not table_exists('products'):
        op.create_table('products',
            ...
            sa.Column('status', sa.Enum('DRAFT', 'RUNNING', 'READY', 'FAILED', name='productstatus', create_type=False), nullable=False),
    ...
    if not table_exists('data_sources'):
        op.create_table('data_sources',
            ...
            sa.Column('type', sa.Enum('WEB', 'DB', 'CONFLUENCE', 'SHAREPOINT', 'FOLDER', name='datasourcetype', create_type=False), nullable=False),
