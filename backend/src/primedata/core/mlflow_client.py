...
class MLflowClient:
    ...
    def get_or_create_experiment(self, product_id: UUID, product_name: str) -> str:
        ...
        try:
            ...
            experiment_id = mlflow.create_experiment(name=experiment_name, artifact_location=self.artifact_location)
    ...
    def log_pipeline_metrics(self, metrics: Dict[str, float], step: Optional[int] = None) -> None:
        """
    ...
    def log_pipeline_artifacts(self, artifacts: List[str], artifact_path: Optional[str] = None) -> None:
        """
    ...
    def log_embedding_metrics(
        self, embedding_count: int, embedding_dimension: int, embedder_name: str, processing_time_seconds: float
    ) -> None:
        """
    ...
    def log_qdrant_metrics(
        self, collection_name: str, vector_count: int, index_time_seconds: float, collection_size_mb: float
    ) -> None:
        """
