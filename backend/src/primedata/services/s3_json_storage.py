...
def load_json_from_s3(s3_path: str, minio_client: Optional[MinIOClient] = None) -> Optional[Any]:
...
def delete_json_from_s3(s3_path: str, minio_client: Optional[MinIOClient] = None) -> bool:
