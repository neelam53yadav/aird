...
def compare_artifacts(
    ...
    comparison = {
        ...
        "differences": {
            ...
            "age_diff_days": (artifact1.created_at - artifact2.created_at).days if artifact1.created_at and artifact2.created_at else None,
        },
    }
