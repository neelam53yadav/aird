    ...
    async def _validate_chunk_coverage(
        ...
        if low_coverage_count > 0:
            violations.append(DataQualityViolation(
                ...
                details={
                    "min_chunk_coverage": rule.min_chunk_coverage,
    ...
    async def _validate_bad_extensions(
        ...
        if bad_files_count > 0:
            violations.append(DataQualityViolation(
                ...
                details={
                    "bad_extensions": rule.bad_extensions,
