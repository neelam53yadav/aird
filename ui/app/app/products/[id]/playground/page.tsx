        ...
        <div className="mb-8">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Search and explore your indexed data with semantic queries</p>
            </div>
          </div>
        </div>
                    ...
                    <div key={index} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                      <div className="flex items-start justify-between mb-2">
                        <div className="flex items-center">
                          ...
                          <span className={`ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${getScoreColor(result.score)}`}>
                      ...
                      <div className="text-xs text-gray-500">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-mono">{result.doc_path.split('/').pop()}</span>
                        </div>
                      </div>
                    </div>
                  ))}
