      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {otherMetrics.map(([key, value]) => {
            ...
            const scoreColor = normalizedValue >= 0.8 ? 'text-green-600' : normalizedValue >= 0.6 ? 'text-yellow-600' : 'text-red-600'
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div
                    className={`h-2 rounded-full ${
                      normalizedValue >= 0.8 ? 'bg-green-500' : normalizedValue >= 0.6 ? 'bg-yellow-500' : 'bg-red-500'
                    }`}
