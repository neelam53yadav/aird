...
import { Mail, Lock, User, CheckCircle2, X, RefreshCw, Key } from "lucide-react"
...
export function AuthButtons({ className }: AuthButtonsProps) {
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <Button
        disabled={true}
        className="w-full bg-gray-100 text-gray-400 border-2 border-gray-200 font-semibold py-3 rounded-lg cursor-not-allowed"
        size="lg"
      >
